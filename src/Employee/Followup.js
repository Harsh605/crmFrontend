...
const TABLE_HEAD = ["Member", "Followup","LeadType", "Remark", "Assigned By", ""];

export default function Followup({ userData }) {
                  ...
                  <td className={classes}>
                    <div className="flex flex-col">
                      ...
                      <Typography
                        ...
                        className="font-normal opacity-70"
                      >
                        {lead.followups.length > 0 && lead.followups[lead.followups.length - 1]?.followupStatus ===
                          "Call Back" &&
