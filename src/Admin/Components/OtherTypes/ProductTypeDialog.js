...
import { getAllProductType, updateProductType } from '../../../slices/leadSlice';

export default function ProductTypeDialog({ open, setOpen,id }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(updateProductType({id,productName})).then(() => {
          setOpen(false)
        }).then(()=>dispatch(getAllProductType()))
      };
