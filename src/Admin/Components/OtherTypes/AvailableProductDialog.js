...
import { getAllAvailableProduct, updateAvailableProduct } from '../../../slices/leadSlice';

export default function AvailableProductDialog({ open, setOpen,id }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(updateAvailableProduct({id,productName})).then(() => {
          setOpen(false)
        }).then(()=>dispatch(getAllAvailableProduct()))
      };
