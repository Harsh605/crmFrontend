...
import { getAllLeadsSource, updateLeadSource } from '../../../slices/leadSlice';

export default function LeadSourceDialog({ open, setOpen,id }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(updateLeadSource({id,leadSourceName})).then(() => {
          setOpen(false)
        }).then(()=>dispatch(getAllLeadsSource()))
      };
