...
import {  getAllSkillType, updateSkillType } from '../../../slices/leadSlice';

export default function SkillTypeDialog({ open, setOpen,id }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(updateSkillType({id,skillName})).then(() => {
          setOpen(false)
        }).then(()=>dispatch(getAllSkillType()))
      };
