...
import { getAllLeadsTypes, updateLeadType } from '../../../slices/leadSlice';

export default function EditTypeDialog({ open, setOpen,id }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(updateLeadType({id,leadName})).then(() => {
          setOpen(false)
        }).then(()=>dispatch(getAllLeadsTypes()))
      };
