...
import AddNewLead from '../Employee/Components/AddNewLead';
import user from "../Images/user.png"
import { deleteLead, getAllLeadsByAdmin } from '../slices/leadSlice';
import { useDispatch, useSelector } from 'react-redux';
import { TrashIcon, PencilIcon } from '@heroicons/react/24/solid';
import { IconButton, Tooltip } from '@material-tailwind/react';
import VisibilityIcon from '@mui/icons-material/Visibility';

const AdminLeads = ({ userData }) => {
    ...
    const filteredLeads = adminLeads?.filter((lead) =>
        ...
        lead.followups[lead.followups?.length - 1]?.assignedTo?.toLowerCase().includes(searchQuery.toLowerCase()) ||
                                ...
                                >
                                    ...
                                    <td className="pl-12">
                                        <p className="text-sm  leading-3 text-gray-600 ">
                                            ...
                                            {lead.followups[lead.followups.length - 1].remarks ? <p className="text-xs leading-3 text-gray-600 pt-2 ">
